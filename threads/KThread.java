...
public class KThread {
	...
	KThread KT1 = new KThread(new PingTest(1)).setName("forked thread");
	KT1.fork();
	KThread KT2 = new KThread(new PingTest(2)).setName("forked thread");
	KT2.fork();
	KT1.join();
	new PingTest(0).run();
    }
     ...
     * Our additions
     */
    private final Semaphore joinSemaphore = new Semaphore(0);
}
